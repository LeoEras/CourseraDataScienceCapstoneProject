...
# GitHub: https://github.com/LeoEras/CourseraDataScienceCapstoneProject
    ...
    navbarPage("Next Word Predict",
               ...
               tabPanel("About",
                        ...
                        div("Next Word Predict is a Shiny app that uses a text
                            ...
                            br(),
                            img(src = "github.png"),
                            a(target = "_blank", href = "https://github.com/LeoEras/CourseraDataScienceCapstoneProject/tree/main/shiny-app",
                            "Next Word Predict")),
                            br(),
                            "Author: Leonardo Eras"
                     )
